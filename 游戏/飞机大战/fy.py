...
class HeroPlane(pygame.sprite.Sprite):
    ...
    def __init__(self,screen):
        ...
        #创建一个飞机图片，当做真正的飞机
        self.player = pygame.image.load(r'.\feiji\5.jpg')
        #根据图片image获取矩形对象
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self,screen,x,y):
        ...
        pygame.sprite.Sprite.__init__(self)
        # 图片
        self.image = pygame.image.load(r'.\feiji\3.jpg')
        # 根据图片image获取矩形对象
...
class GameSound():
    def __init__(self):
        ...
        pygame.mixer.music.load(r'.\feiji\吹梦到西洲.mp3')
...
class Manager():
    ...
    def __init__(self):
        ...
        #创建背景图片
        self.background = pygame.image.load('./feiji/女生 女子 起床 晚上 都市 夜景 4k动漫壁纸_彼岸图网.jpg')
        #初始化一个装玩家精灵的group
