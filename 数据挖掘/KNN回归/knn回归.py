...
#Delete unnecessary feature columns, because the category information is not useful for regression prediction
data.drop(['Species'],axis=1,index=None,inplace=True)
